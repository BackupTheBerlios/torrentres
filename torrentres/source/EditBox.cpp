...
// $Id: EditBox.cpp,v 1.1 2004/03/31 20:39:09 deepb Exp $
//////////////////////////////////////////////////
//
...
// EditBox.cpp
//
// This was for the Log file but I don't know if
// I'm going to use it
//
...
IMPLEMENT_DYNAMIC(EditBox, CRichEditCtrl)
EditBox::EditBox()
{
}
...
BEGIN_MESSAGE_MAP(EditBox, CRichEditCtrl)
END_MESSAGE_MAP()
...
void EditBox::Print(const char * Format, ...)
{
	char Buffer[2048];
	...
	va_end(Args);
	MessageBox(Buffer,"TorrenTres Log");
	SetSel(GetTextLength(), GetTextLength());
	ReplaceSel(Buffer, FALSE);
}