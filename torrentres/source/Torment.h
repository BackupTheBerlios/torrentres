...
// $Id: Torment.h,v 1.1 2004/03/31 20:39:09 deepb Exp $
//////////////////////////////////////////////////
//
...
// TormentApp:
// See Torment.cpp for the implementation of this class
//

class TormentApp : public CWinApp
{
public:
	TormentApp();
...
protected:
	TormentWnd m_Wnd;
public:
	DWORD GetNumArgs(void);
	CString GetArg(DWORD Arg);
};

extern TormentApp theApp;